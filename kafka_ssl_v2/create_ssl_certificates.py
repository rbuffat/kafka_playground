...
brokers = [
    ...
    Broker(
        "kafka_ssl_v2-zookeeper-1.kafka_ssl_default",
        dns=["kafka_ssl_v2-zookeeper-1.kafka_ssl_default"],
        truststorepass="trustzookeeper",
        keystorepass="keypw_zookeeper",
    ),
    Broker(
        "kafka_ssl_v2-zookeeper2-1.kafka_ssl_default",
        dns=["kafka_ssl_v2-zookeeper2-1.kafka_ssl_default"],
        truststorepass="trustzookeeper2",
        keystorepass="keypw_zookeeper2",
    ),
    Broker(
        "kafka_ssl_v2-zookeeper3-1.kafka_ssl_default",
        dns=["kafka_ssl_v2-zookeeper3-1.kafka_ssl_default"],
