...
brokers = [
    ...
    Broker(
        "kafkasslv3-zookeeper-1.kafka",
        dns=["kafkasslv3-zookeeper-1.kafka"],
        truststorepass="trustzookeeper",
        keystorepass="keypw_zookeeper",
    ),
    Broker(
        "kafkasslv3-zookeeper2-1.kafka",
        dns=["kafkasslv3-zookeeper2-1.kafka"],
        truststorepass="trustzookeeper2",
        keystorepass="keypw_zookeeper2",
    ),
    Broker(
        "kafkasslv3-zookeeper3-1.kafka",
        dns=["kafkasslv3-zookeeper3-1.kafka"],
